...
class _CourierHistoryScreenState extends State<CourierHistoryScreen> {
            ...
            children: [
              ...
              ListTile(
                leading: Icon(
                  ...
                  color: _isNewestFirst ? const Color(0xFF0F4D19) : Colors.grey,
                ),
                title: const Text('Terbaru (Tanggal Selesai)'),
                trailing: _isNewestFirst
                    ? const Icon(Icons.check_circle, color: Color(0xFF0F4D19))
                    : null,
                onTap: () {
                  setState(() {
                    _isNewestFirst = true;
                    ...
                    child: Column(
                      children: [
                        ...
                        _buildDetailRow(
                          ...
                          'Tanggal Selesai',
                          job.completedAt?.split('T').first ?? '-',
                        ),
                        const Divider(height: 20),
                        _buildDetailRow(
                          Icons.local_shipping_outlined,
                          'Layanan',
                          job.vehicleType == 'EcoCargo'
                              ? 'EcoCargo'
                              : 'EcoRide',
                        ),
                      ],
  ...
  Widget build(BuildContext context) {
    ...
    final totalWeight = completed.fold<double>(0.0, (sum, job) {
      return sum +
          (double.tryParse(job.actualTotalWeight?.toString() ?? '0') ?? 0.0);
    });
